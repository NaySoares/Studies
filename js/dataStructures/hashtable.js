...
function Hashtable() {
  ...
  this.put = function(key, value) {
    //insert element
    var position = losolosenHashCode(key)
  ...
  this.remove = function(key) {
    //remove a element
    table[losolosenHashCode(key)] = undefined
  }

  this.get = function(key) {
    //retorns a value if the key exists
    return table[losolosenHashCode(key)]
  }

  var losolosenHashCode = function(key) {
    //returns the hash
    var hash = 0
